...
export default class Parse {
  ...
  private parse_fn_declaration(): Stmt {
    ...
    this.expect(
      TokenType.OpenBrace,
      "Expected opening brace in function body.",
    );
  ...
  parse_var_declaration(): Stmt {
    ...
    if (this.at().type === TokenType.Semicolon) {
      ...
      if (isConstant) {
        throw "Must assigne value to coonstant expression. No value provided.";
      }
      return {
        kind: "VarDeclaration",
        identifier,
    ...
    this.expect(
      TokenType.Semicolon,
      "variable declaration statment must end with a semicolon.",
    );
    return declaration;
  }
  ...
  private parse_object_expr(): Expr {
    ...
    while (this.not_eof() && this.at().type !== TokenType.CloseBrace) {
      ...
      if (this.at().type !== TokenType.CloseBrace) {
        this.expect(
          TokenType.Comma,
          "Expected comma or closing fllowing property.",
        );
      }
  ...
  private parse_args(): Expr[] {
    this.expect(
      TokenType.OpenParen,
      "Expected opening paren in call expression.",
    );
    ...
    while (
      ...
      if (operator.type === TokenType.Dot) {
        ...
        if (property.kind !== "Identifier") {
          throw `Cannot access property of non-object type: ${property.kind}`;
        }
      } else {
        // this allow obj["computedValue"]
        computed = true;
